...
import { MoreHorizontal, Plus, SlidersHorizontal, X } from "lucide-react";
  ...
  return (
    <HeaderPage title="Invoices">
      ...
      <div className="space-y-3">
        ...
        >
          <TabsList className="w-full justify-between rounded-xl bg-transparent p-0">
            <TabsTrigger
              value="all"
              className="h-10 flex-1 justify-start rounded-lg border bg-background px-3"
            >
              All invoices
            </TabsTrigger>
            <TabsTrigger
              value="draft"
              className="ml-2 h-10 flex-1 justify-start rounded-lg border bg-background px-3"
            >
              Draft
            </TabsTrigger>
            <TabsTrigger
