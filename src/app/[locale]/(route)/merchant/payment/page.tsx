...
export default function PaymentPage() {
  ...
  const filteredInvoices = invoices.filter(
    (inv) =>
      (inv.recipientName?.toLowerCase() || "").includes(
  ...
  return (
    <HeaderPage title="Make a Payment">
                  ...
                  >
                    {selectedInvoiceId
                      ? (() => {
                          ...
                          return inv
                            ? `${inv.recipientName} - $${inv.amount.toLocaleString()}`
                            : "Select an invoice...";
                        })()
                      : "Select an invoice..."}
                ...
                >
                  <div className="flex items-center border-b px-3">
                    ...
                    <Input
                      ...
                      className="placeholder:text-muted-foreground flex h-11 w-full rounded-md border-none bg-transparent py-3 text-sm shadow-none outline-none focus-visible:ring-0 disabled:cursor-not-allowed disabled:opacity-50"
                      value={searchQuery}
