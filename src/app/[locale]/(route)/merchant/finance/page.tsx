...
export default function FinancePage() {
  ...
  const monthlyInvoices = invoices.filter((inv) =>
    inv.invoiceDate.startsWith(selectedMonth),
  );
  ...
  const unpaidCount = monthlyInvoices.filter((inv) =>
    ["pending", "approved", "draft"].includes(inv.status),
  ).length;
