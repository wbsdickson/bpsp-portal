    ...
    return (
        <div className="h-full flex-1 flex-col space-y-8 p-8 md:flex">
            <div className="flex items-center justify-between space-y-2">
                <div>
                    <h2 className="text-2xl font-bold tracking-tight">Edit Finance Record</h2>
                    <p className="text-muted-foreground">
                        Edit receivable or payable details.
                    </p>
                </div>
            </div>
            <div className="max-w-4xl">
                <InvoiceForm merchantId={merchantId} invoice={invoice} enableFinanceFields={true} />
            </div>
        </div>
    );
}
