...
const DateInput = ({ value, onChange, className }: DateInputProps) => {
  ...
  return (
    ...
    >
      <input
        ...
        className="bg-background w-6 border-none p-0 text-center outline-none"
        placeholder="M"
      />
      ...
      <input
        ...
        className="bg-background w-7 border-none p-0 text-center outline-none"
        placeholder="D"
      />
      <span className="-mx-px opacity-20">/</span>
      <input
        ...
        className="bg-background w-12 border-none p-0 text-center outline-none"
        placeholder="YYYY"
      />
    </div>
  );
