...
export type BankTransferPayoutStatus = Payment["status"];

type BankTransferTransactionStoreState = {
...
export const useBankTransferTransactionStore =
  create<BankTransferTransactionStoreState>((set, get) => ({
